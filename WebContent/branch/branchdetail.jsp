								...
								<div class="form-group input-group mb-3">
									...
									<div class="form-group custom-file">
										<input type="file" class="custom-file-input" name="upfile"
											aria-describedby="inputGroupFileAddon01" onchange="fileCheck(this)"> 
										<label class="custom-file-label" for="inputGroupFile01" id="branch-image">
										매장사진 ( <%=branch.getImageSrc()%> )</label>
									</div>
								</div>
